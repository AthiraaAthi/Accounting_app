...
mixin _$CategoryState {
  ...
  List<CategoryModel> get categoryNames => throw _privateConstructorUsedError;
...
class _$CategoryStateImpl implements _CategoryState {
  const _$CategoryStateImpl(
      ...
      required final List<CategoryModel> categoryNames,
      required this.getFailureOrSuccessState})
      : _categoryNames = categoryNames;

  @override
  final bool isLoading;
  final List<CategoryModel> _categoryNames;
  @override
  List<CategoryModel> get categoryNames {
  ...
  @override
  String toString() {
    return 'CategoryState(isLoading: $isLoading, categoryNames: $categoryNames, getFailureOrSuccessState: $getFailureOrSuccessState)';
  }
